...
xOrig = [1,2,3,4,5,9,10,11,12,13,14,15,21,22,23,24,25,26,27];
yOrig = [1,2,8,7,6,1,1,2,2,3,4,5,2,-3,-10,10,-2,5,6];
...
for cycle = 1:2
    ...
    % Add first two elements (fixed kernel size of 5)
    yg = [y(1), y(2)];
    ...
    % Add last two elements (fixed kernel size of 5)
    yg = [yg, y(size(x,2) - 1), y(size(x,2))];
    
    % put filtered values back into result array
    y = yg;
